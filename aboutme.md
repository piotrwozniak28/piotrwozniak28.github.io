...
W telegraficznym skrócie: zacząłem od Oracle - tj. programowałem aplikacje w Oracle APEX i natywne ETL z użyciem PL/SQL. Dzięki zaufaniu wielu osób, otrzymałem szansę aby wykazać się w Pythonie, chmurze i bezpośredniej pracy z klientem - aż po C-level. Obecnie działam jako konsultant GCP.
...
#### Boks
- Wygrałem kilka walk przed czasem.
